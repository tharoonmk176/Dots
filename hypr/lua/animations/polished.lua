-- Polished: snappy lightweight springs, quick workspace fades, subtle border sweep
...
-- Lightweight spring: low mass (0.6) + high stiffness (170) for instant, fluid movement
hl.curve("smooth", { type = "spring", mass = 0.6, stiffness = 170, dampening = 19 })
...
hl.animation({ leaf = "windows", enabled = true, speed = 6.0, spring = "smooth" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 6.5, spring = "smooth", style = "popin 85%" })
hl.animation({ leaf = "windowsOut", enabled = true, speed = 2.5, bezier = "snappy", style = "popin 85%" })
hl.animation({ leaf = "windowsMove", enabled = true, speed = 5.5, spring = "smooth" })
...
hl.animation({ leaf = "fadeLayersOut", enabled = true, speed = 2.0, bezier = "almostLinear" })

hl.animation({ leaf = "workspaces", enabled = true, speed = 2.4, bezier = "almostLinear", style = "fade" })
hl.animation({ leaf = "zoomFactor", enabled = true, speed = 6.5, bezier = "quick" })
